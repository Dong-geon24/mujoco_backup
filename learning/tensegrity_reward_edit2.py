...
class TensegrityEnv(MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        #increase distance reward
        # 이동 거리 증가 보상
        distance_increase_reward = self._distance_increase_reward_weight * (distance_traveled - self.previous_distance_traveled if distance_traveled > self.previous_distance_traveled else 0)
        self.previous_distance_traveled = distance_traveled  # 갱신
